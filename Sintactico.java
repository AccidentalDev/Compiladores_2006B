            ...
            case 176:{
                  if(tipoElem==5||tipoElem==9||tipoElem==10||tipoElem==11||tipoElem==7||tipoElem==25||lexema.equals("+")||lexema.equals("-")){
                     ...
                     if(tipoElem==2){
                        ...
                        String err="Se esperaba un corchete de apertura o una expresión y se encontró: "+lexema;
                        poneError(2,err);
                        ...
                        if(stmp!=null){
                           if(!tipo.equals(stmp.tipo_dato)){
                              if(stmp.tipo_dato.equals("<Real>")){
                                 if(!tipo.equals("<Entero>")){
                                    String err="Se esperaba un "+stmp.tipo_dato+" y se encontró un "+tipo+" al definir el elemento dentro del arreglo: \""+tmp.idKey+"\"";
                                    poneError2(3,err);
                                 }
                              }else{
                                 String err="Se esperaba un "+stmp.tipo_dato+" y se encontró un "+tipo+" al definir el elemento dentro del arreglo: \""+tmp.idKey+"\"";
                  ...
                  if(tipoElem==4)
                     ...
                     if(tipoElem==3){
                        ...
                        if(!pilaPadres.isEmpty()){
                           ...
                           if(simb!=null){
                              if(d1c<simb.d1){
                                 String err="El arreglo se definió para contener "+simb.d1+" elementos y solo se encontraron "+d1c+": "+tmp.idKey;
                                 poneError(3,err);
                              }
                              tmp.idKey="";
                           }
            ...
            case 209:{
                  if(tipoElem==5||tipoElem==9||tipoElem==10||tipoElem==11||tipoElem==7||tipoElem==25||lexema.equals("+")||lexema.equals("-")){
                     ...
                     if(!pilaPadres.isEmpty()){
                        ...
                        if(simb!=null){
                           if(d1c==simb.d1+1){
                              String err="El arreglo se definió para contener solo "+simb.d1+" elementos: "+tmp.idKey;
                              poneError2(3,err);
                           }
                        }
                     }
                  }else{
                     String err="Se esperaba una expresión y se encontró: "+lexema;
                     poneError(2,err);
            ...
            case 178:{
                  if(tipoElem==5||tipoElem==9||tipoElem==10||tipoElem==11||tipoElem==7||tipoElem==25||lexema.equals("+")||lexema.equals("-")){
                     ...
                     if(!pilaPadres.isEmpty()){
                        ...
                        if(simb!=null){
                           if(d2c==simb.d2+1){
                              String err="El arreglo se definió para contener solo "+simb.d2+" elementos por subarreglo: "+tmp.idKey;
                              poneError(3,err);
                           }
                        }
                     }
            ...
            case 180:{
                  if(tipoElem==2){
                     ...
                     if(!pilaPadres.isEmpty()){
                        ...
                        if(simb!=null){
                           if(d1c==simb.d1+1){
                              String err="El arreglo se definió para contener solo "+simb.d1+" subarreglos: "+tmp.idKey;
                              poneError(3,err);
                           }
                        }
                     }
